...
command1 = PATH_RANDOMTRIP + " -n" + PATH_NET + " -r " + PATH_ROUTE +" -b " + str(begin) +  " -e " + str(end) + " --insertion-rate " +  str(insertionRate) + " -l -s " + str(seed)
...
command2 = "sumo -c ../sumo/simulation" + str(seed) + ".sumo.cfg --fcd-output ../sumo/vehicle" + str(seed) +".sumo.xml --fcd-output.geo"
...
print(f'DONE init_vehicle: vehicle[{seed}].sumo.xml file')