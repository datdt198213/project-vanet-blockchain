...
for i in range(1, 5):
    ...
    command = "python3 py_init_simulation.py " + str(times) + " " + str(insertionRate)
    os.system(command)

    # init data of vehicle
    command = "python3 py_init_vehicle.py " + str(times) + " " + str(insertionRate)
    os.system(command)

    # convert xml data of vehicle to 
    command = "python3 py_convert_data.py " + str(times) + " " + str(insertionRate)
    os.system(command)
